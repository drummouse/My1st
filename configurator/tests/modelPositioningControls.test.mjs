...
test('viewer controls group Front Back Left Right and Top in a separate bounded corner', async () => {
  ...
  assert.match(css, /\.workspace-root \.viewer-direction-controls\s*\{[^}]*position:\s*absolute[^}]*right:\s*0\.75rem/s);
