...
export default function SalesModeShell({
  ...
  return (
    <div className={`${embedded ? 'workspace-shell' : 'workspace-root'} sales-workspace${detailsOpen ? '' : ' is-details-closed'}${projectSetup ? ' is-project-setup' : ''}`} data-workspace-mode="sales">
      ...
      <div className="sales-workspace-mobile-header">
        <MobileWorkspaceHeader
          ...
          action={!detailsOpen && typeof onDetailsOpenChange === 'function'
            ? {
