...
export default function SettingsPanel({ onSaved, libraryOptions = { products: [], services: [] } }) {
  ...
  return (
    <div className="settings-panel settings-panel-grid">
      ...
      <div className="control-block settings-measurement-card">
      ...
      {form.expertModeEntitled && (
        <div className="control-block settings-expert-card">
      ...
      {profile && (
        <div className="control-block settings-profile-card">
      ...
      <div className="control-block settings-tax-card">
      ...
      <div className="control-block settings-defaults-card">
      ...
      <div className="control-block settings-branding-card">
      ...
      <div className="control-block settings-notifications-card">
